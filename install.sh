...
#executando Docker
sleep 15
if sudo docker exec -i Noctu mysql -u root -paluno < /home/ubuntu/Noct-U/script-instalacao-kevin/confBanco.sql; then
    echo "..."
...
sudo chmod +x /home/ubuntu/Noct-U/script-instalacao-kevin/java.sh
