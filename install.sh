...
#executando Docker
sleep 15
if sudo docker exec -i Noctu mysql -u root -p aluno < /home/ubuntu/script-instalacao-kevin/confBanco.sql; then
    echo "..."
...
sudo chmod +x /home/ubuntu/script-instalacao-kevin/java.sh
